...
Kor_Tasks[Kor Tasks]
Output[Output]
Set-Up **(In this order)** --> Algorithm3 --> Algorithm4 --Networks trained within LearnHeuristicPrac--> TrainingNNs --> Kor_Tasks --> Algorithm4 --> Output
subgraph "Set-Up **(In this Order)**"
